...
/** Draw a string scaled by `scale` (e.g. 2 = 16x32 glyphs) into an in-memory framebuffer. */
void st7789_draw_string_fb_scaled(uint16_t *fb, uint16_t x, uint16_t y, const char *str, uint8_t scale, uint16_t color, uint16_t bg);
